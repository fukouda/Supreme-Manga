  ...
  <div class="row">
    <div class="col-sm-9">
       <div class="row">
		...
		<img src="<?php echo $manga['cover']; ?>" style=" border-radius: 25px; border: 2px solid #8AC007;">
		...
		<?php $i = 1; foreach($manga['chapters'] as $chapter){ if(isset($chapter)){ $title = $chapter; }else{ $title= 'No Title Available'; } echo "<tr><td align='center'><a href='pages/readmanga?page=1&siteId=" . $_GET['siteId'] . "&mangaId=" . $_GET['mangaId'] . "&chapterId=" . $i . "'>" . $i . "</a></td><td style='padding-left: 10%;'><a href='pages/readmanga?page=1&siteId=" . $_GET['siteId'] . "&mangaId=" . $_GET['mangaId'] . "&chapterId=" . $i . "'>" . $title . "</a></tr>"; $i++; }?>
